...
//
//  Created by sam hastings on 14/10/2024.
//
...
final class EssentialFeedAPIEndToEndTests: XCTestCase {
    ...
    func test_endToEndTestServerGETFeedResult_matchesFixedAccountData() {
        ...
        case let .failure(error)?:
            XCTFail("Expected successful feed result, got \(error.localizedDescription) instead.")
        default:
            XCTFail("Expecting successful feed result, got no result instead.")
        }
    }
