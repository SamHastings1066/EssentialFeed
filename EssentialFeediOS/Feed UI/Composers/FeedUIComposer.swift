...
public final class FeedUIComposer {
    ...
    public static func feedComposedWith(feedLoader: FeedLoader, imageLoader: FeedImageDataLoader) -> FeedViewController {
        ...
        let presentationAdapter = FeedLoaderPresenationAdapter(feedLoader: feedLoader, presenter: presenter)
...
private final class FeedLoaderPresenationAdapter: FeedRefreshViewControllerDelegate {
